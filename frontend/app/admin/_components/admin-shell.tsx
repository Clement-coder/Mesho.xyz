...
export function AdminShell({ active, onTab, badges = {}, children }: AdminShellProps) {
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Mobile top tabs */}
      <div className="md:hidden fixed top-[57px] left-0 right-0 z-30 bg-card border-b border-border flex overflow-x-auto gap-1 px-2 py-2">
        {adminTabs.map(t => {
          const Icon = t.icon;
          const badge = badges[t.id];
          return (
      ...
      <main className="flex-1 md:ml-56 pt-[57px] md:pt-0">
        <div className="md:hidden h-14" />{/* spacer for mobile tabs */}
