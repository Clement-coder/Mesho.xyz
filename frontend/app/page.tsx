    ...
    <div className="w-full">
      ...
      <section className="py-16 md:py-24 px-4 bg-card border-t border-border">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: 'FileText', title: 'Research Materials', desc: 'Access department-specific project topics and full research materials after payment.', href: '/departments' },
              { icon: 'BarChart3', title: 'SPSS Training', desc: 'Structured training in academic data analysis using SPSS — from coding to interpretation.', href: '/training' },
