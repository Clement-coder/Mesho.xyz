      ...
      <div className="min-h-screen w-full px-4 sm:px-6 py-8 pb-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <a href="/dashboard" className="flex items-center gap-2 text-sm text-accent hover:text-accent/80 transition-colors font-medium">
              ← Dashboard
            </a>
          </div>
            ...
            <div className="lg:col-span-1">
              <div className="clay p-6 text-center">
                <div className="relative inline-block mb-4">
                  ...
                  <label className="absolute bottom-0 right-0 w-7 h-7 bg-accent text-white rounded-full flex items-center justify-center cursor-pointer hover:bg-accent/80 transition-colors" title="Upload profile picture" aria-label="Upload a new profile picture">
